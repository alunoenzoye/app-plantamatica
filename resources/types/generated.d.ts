...
export enum PermissionsEnum { calls_approve = 'calls.approve', calls_delete = 'calls.delete', tasks_index = 'tasks.index', tasks_edit = 'tasks.edit', tasks_complete = 'tasks.complete' };
